...
class SampleForVKF(models.Model):
    fileTRAIN_type = models.CharField('Тип файла', max_length = 100) #для обучающей или для тестовой выборки - обуч или тест
    fileTRAIN_name = models.CharField('Название файла', max_length = 100)
    fileTRAIN_path = models.CharField('Путь к файлу', max_length = 200)
    fileTRAIN_attr = models.CharField('Целевое свойство', max_length = 10)
    fileTRAIN_table = models.CharField('Имя таблицы', max_length = 100)

    def __str__(self):
        return self.fileTRAIN_name
